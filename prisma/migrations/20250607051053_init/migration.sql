...
CREATE TABLE `transaction_info` (
    ...
    INDEX `transaction_info_date_voucherNo_voucherType_idx`(`date`, `voucherNo`, `voucherType`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `inventories` (
    ...
    `rawId` INTEGER NULL,
    `createProductId` INTEGER NULL,
    `logToRawId` INTEGER NULL,
    `unitePrice` DOUBLE NOT NULL DEFAULT 0.00,
    ...
    INDEX `inventories_productId_rawId_createProductId_idx`(`productId`, `rawId`, `createProductId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `journals` (
    ...
    INDEX `journals_inventoryItemId_accountsItemId_idx`(`inventoryItemId`, `accountsItemId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `log_orders` (
    ...
    `status` ENUM('UNCHECKED', 'CHECKED', 'CLOSED') NOT NULL DEFAULT 'UNCHECKED',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
-- CreateTable
CREATE TABLE `LogOrdByCategory` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `logOrderId` INTEGER NOT NULL,
    `logToRawId` INTEGER NOT NULL,
    `categoryId` INTEGER NOT NULL,
    `date` DATETIME(3) NOT NULL,
    `unitePrice` DOUBLE NOT NULL,
    `quantityAdd` DOUBLE NOT NULL,
    `quantityLess` DOUBLE NOT NULL,
...
-- CreateTable
CREATE TABLE `LogToRaw` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `oucherNo` VARCHAR(191) NOT NULL,
    `date` DATETIME(3) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `LogToRaw_oucherNo_key`(`oucherNo`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `inventories` ADD CONSTRAINT `inventories_createProductId_fkey` FOREIGN KEY (`createProductId`) REFERENCES `CreateProduct`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `inventories` ADD CONSTRAINT `inventories_logToRawId_fkey` FOREIGN KEY (`logToRawId`) REFERENCES `LogToRaw`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `journals` ADD CONSTRAINT `journals_createProductId_fkey` FOREIGN KEY (`createProductId`) REFERENCES `CreateProduct`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `LogOrdByCategory` ADD CONSTRAINT `LogOrdByCategory_logToRawId_fkey` FOREIGN KEY (`logToRawId`) REFERENCES `LogToRaw`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `LogOrdByCategory` ADD CONSTRAINT `LogOrdByCategory_logOrderId_fkey` FOREIGN KEY (`logOrderId`) REFERENCES `log_orders`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
